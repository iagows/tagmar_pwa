...
export const DEUSES: Deus[] = [
	...
	},
	{
		id: DeusEnum.GANIS,
		descricao:
			"Caprichosa e de personalidade instável, a ela pertencem às coisas do mar, das águas em geral. Mãe dos Deuses Quiris e Liris, gerou ainda, a partir de fios dourados de seus cabelos, as ninfas de Tagmar, criaturas muito comuns antes do Cataclismo, só encontradas atualmente em Dartel.",
	},
	{
		id: DeusEnum.LENA,
		descricao:
	...
	},
	{
		id: DeusEnum.PLANDIS,
		descricao:
			"Irmão de Lena, é o Deus da paixão cega, da inconsequência e dos loucos.",
	},
	{
		id: DeusEnum.SELIMOM,
		descricao:
