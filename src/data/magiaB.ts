...
Além disso, a vítima após uma hora de enfeitiçada esquecerá quem foi a pessoa que lhe passou a informação. Ela não se lembrará de seu nome nem rosto nem qualquer outro elemento que possa identificá-la, mas saberá que veio de uma fonte altamente "confiável".`,
	...
	},
	{
		...
		niveis: [
			{
				id: "0",
				descricao: "Causa 12 pontos de dano em uma esfera de 1 metro de raio.",
				nivel: 1,
			},
			{
				id: "1",
				descricao: "Causa 16 pontos de dano em uma esfera de 2 metros de raio.",
				nivel: 2,
			},
			{
				id: "2",
				descricao: "Causa 20 pontos de dano em uma esfera de 4 metros de raio.",
				nivel: 3,
			},
			{
				id: "3",
				descricao: "Causa 28 pontos de dano em uma esfera de 6 metros de raio.",
				nivel: 5,
			},
			{
				id: "4",
